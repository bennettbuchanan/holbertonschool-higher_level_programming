...
VALUES (
            (SELECT id
             ...
             WHERE first_name = 'Jon'
                 AND last_name = 'Snow'), 'Brown');

INSERT INTO EyesColor (person_id, color)
VALUES (
            (SELECT id
             FROM Person
             WHERE first_name = 'Arya'
                 AND last_name = 'Stark'), 'Green');
...
-- SELECT id FROM Person CROSS JOIN TVShowPerson;
